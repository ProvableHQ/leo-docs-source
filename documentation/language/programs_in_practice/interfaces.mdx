---
id: interfaces
title: Interfaces and Dynamic Dispatch
...
- **Interfaces** — declare a named contract structure that programs must fulfill
...
Interfaces are a compile-time concept and have no impact on the bytecode generated.
...
runtime.
 ...
 Interfaces are declared outside the `program {}` block or in a submodule.
...
### Dynamic Records in Dynamic Calls
