...
| [Snark::verify](#snarkverify)                             | Verify a single Varuna ZK proof onchain            |
| [Snark::verify_batch](#snarkverify_batch)                 | Batch-verify multiple Varuna ZK proofs onchain     |
...
```leo
let result: [bool; 256] = Keccak256::hash_to_bits(aleo1...);
let result: [bool; 256] = Keccak256::hash_to_bits(true);
let result: [bool; 256] = Keccak256::hash_to_bits(1field);
let result: [bool; 256] = Keccak256::hash_to_bits(1group);
let result: [bool; 256] = Keccak256::hash_to_bits(1i8);
let result: [bool; 256] = Keccak256::hash_to_bits(1i16);
let result: [bool; 256] = Keccak256::hash_to_bits(1i32);
let result: [bool; 256] = Keccak256::hash_to_bits(1i64);
let result: [bool; 256] = Keccak256::hash_to_bits(1i128);
let result: [bool; 256] = Keccak256::hash_to_bits(1u8);
let result: [bool; 256] = Keccak256::hash_to_bits(1u16);
let result: [bool; 256] = Keccak256::hash_to_bits(1u32);
let result: [bool; 256] = Keccak256::hash_to_bits(1u64);
let result: [bool; 256] = Keccak256::hash_to_bits(1u128);
...
```leo
let result: [bool; 384] = Keccak384::hash_to_bits(aleo1...);
let result: [bool; 384] = Keccak384::hash_to_bits(true);
let result: [bool; 384] = Keccak384::hash_to_bits(1field);
let result: [bool; 384] = Keccak384::hash_to_bits(1group);
let result: [bool; 384] = Keccak384::hash_to_bits(1i8);
let result: [bool; 384] = Keccak384::hash_to_bits(1i16);
let result: [bool; 384] = Keccak384::hash_to_bits(1i32);
let result: [bool; 384] = Keccak384::hash_to_bits(1i64);
let result: [bool; 384] = Keccak384::hash_to_bits(1i128);
let result: [bool; 384] = Keccak384::hash_to_bits(1u8);
let result: [bool; 384] = Keccak384::hash_to_bits(1u16);
let result: [bool; 384] = Keccak384::hash_to_bits(1u32);
let result: [bool; 384] = Keccak384::hash_to_bits(1u64);
let result: [bool; 384] = Keccak384::hash_to_bits(1u128);
...
```leo
let result: [bool; 512] = Keccak512::hash_to_bits(aleo1...);
let result: [bool; 512] = Keccak512::hash_to_bits(true);
let result: [bool; 512] = Keccak512::hash_to_bits(1field);
let result: [bool; 512] = Keccak512::hash_to_bits(1group);
let result: [bool; 512] = Keccak512::hash_to_bits(1i8);
let result: [bool; 512] = Keccak512::hash_to_bits(1i16);
let result: [bool; 512] = Keccak512::hash_to_bits(1i32);
let result: [bool; 512] = Keccak512::hash_to_bits(1i64);
let result: [bool; 512] = Keccak512::hash_to_bits(1i128);
let result: [bool; 512] = Keccak512::hash_to_bits(1u8);
let result: [bool; 512] = Keccak512::hash_to_bits(1u16);
let result: [bool; 512] = Keccak512::hash_to_bits(1u32);
let result: [bool; 512] = Keccak512::hash_to_bits(1u64);
let result: [bool; 512] = Keccak512::hash_to_bits(1u128);
...
```leo
let result: [bool; 256] = SHA3_256::hash_to_bits(aleo1...);
let result: [bool; 256] = SHA3_256::hash_to_bits(true);
let result: [bool; 256] = SHA3_256::hash_to_bits(1field);
let result: [bool; 256] = SHA3_256::hash_to_bits(1group);
let result: [bool; 256] = SHA3_256::hash_to_bits(1i8);
let result: [bool; 256] = SHA3_256::hash_to_bits(1i16);
let result: [bool; 256] = SHA3_256::hash_to_bits(1i32);
let result: [bool; 256] = SHA3_256::hash_to_bits(1i64);
let result: [bool; 256] = SHA3_256::hash_to_bits(1i128);
let result: [bool; 256] = SHA3_256::hash_to_bits(1u8);
let result: [bool; 256] = SHA3_256::hash_to_bits(1u16);
let result: [bool; 256] = SHA3_256::hash_to_bits(1u32);
let result: [bool; 256] = SHA3_256::hash_to_bits(1u64);
let result: [bool; 256] = SHA3_256::hash_to_bits(1u128);
...
```leo
let result: [bool; 384] = SHA3_384::hash_to_bits(aleo1...);
let result: [bool; 384] = SHA3_384::hash_to_bits(true);
let result: [bool; 384] = SHA3_384::hash_to_bits(1field);
let result: [bool; 384] = SHA3_384::hash_to_bits(1group);
let result: [bool; 384] = SHA3_384::hash_to_bits(1i8);
let result: [bool; 384] = SHA3_384::hash_to_bits(1i16);
let result: [bool; 384] = SHA3_384::hash_to_bits(1i32);
let result: [bool; 384] = SHA3_384::hash_to_bits(1i64);
let result: [bool; 384] = SHA3_384::hash_to_bits(1i128);
let result: [bool; 384] = SHA3_384::hash_to_bits(1u8);
let result: [bool; 384] = SHA3_384::hash_to_bits(1u16);
let result: [bool; 384] = SHA3_384::hash_to_bits(1u32);
let result: [bool; 384] = SHA3_384::hash_to_bits(1u64);
let result: [bool; 384] = SHA3_384::hash_to_bits(1u128);
...
```leo
let result: [bool; 512] = SHA3_512::hash_to_bits(aleo1...);
let result: [bool; 512] = SHA3_512::hash_to_bits(true);
let result: [bool; 512] = SHA3_512::hash_to_bits(1field);
let result: [bool; 512] = SHA3_512::hash_to_bits(1group);
let result: [bool; 512] = SHA3_512::hash_to_bits(1i8);
let result: [bool; 512] = SHA3_512::hash_to_bits(1i16);
let result: [bool; 512] = SHA3_512::hash_to_bits(1i32);
let result: [bool; 512] = SHA3_512::hash_to_bits(1i64);
let result: [bool; 512] = SHA3_512::hash_to_bits(1i128);
let result: [bool; 512] = SHA3_512::hash_to_bits(1u8);
let result: [bool; 512] = SHA3_512::hash_to_bits(1u16);
let result: [bool; 512] = SHA3_512::hash_to_bits(1u32);
let result: [bool; 512] = SHA3_512::hash_to_bits(1u64);
let result: [bool; 512] = SHA3_512::hash_to_bits(1u128);
...
Verifies a single Varuna ZK proof onchain. Only callable from inside a `final { }` block.
...
Batch-verifies multiple Varuna ZK proofs onchain. Only callable from inside a `final { }` block. The number of verifying keys (`M`) must equal the number of circuits in `inputs` (`K`).
