...
See the full `leo devnet` CLI documentation [here](../cli/devnet.mdx)
...
Once your private key and endpoint have been correctly set, deploying and executing largely function the same as they would on Testnet or Mainnet. For more details on either of those processes, check out the [**Deploying**](./deploying.mdx) and [**Executing**](./executing.mdx) guides.
