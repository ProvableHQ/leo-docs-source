...
| `mappings`          | Onchain key-value storage declarations                             |
...
Mappings define onchain key-value storage:
...
The ABI uses **Leo types** (the high-level representation). When interacting with the Aleo VM directly, downstream tooling must apply transformations to understand the onchain representation.
...
- [Leo Build Command](../cli/build.mdx) - CLI reference for building programs
- [Data Types](../language/data_types.mdx) - Leo type system reference
- [The Finalization Model](./finalization.mdx) - Understanding the proof and finalization execution contexts
